...
public class AdminMemberController {
    ...
    @RequestMapping(value = {"/detail", "/detail/{userIdx}"},
    ...
    public ResponseEntity<UserDto> memberDetail(
        ...
        if (finalIdx == null) return ResponseEntity.badRequest().build();
    ...
    public String sanctionList(
            @RequestParam(name = "page",           defaultValue = "1") int page,
            @RequestParam(name = "kwd",            required = false)   String kwd,
            @RequestParam(name = "sanctionFilter", required = false)   String sanctionFilter,
            Model model) {
        ...
        model.addAttribute("page",           page);
        model.addAttribute("kwd",            kwd);
        model.addAttribute("sanctionFilter", sanctionFilter);
    ...
    public String withdrawalList(
            @RequestParam(name = "page",    defaultValue = "1") int page,
            @RequestParam(name = "kwd",     required = false)   String kwd,
            @RequestParam(name = "wFilter", required = false)   String wFilter,
            Model model) {
        ...
        model.addAttribute("page",       page);
        model.addAttribute("kwd",        kwd);
        model.addAttribute("wFilter",    wFilter);
