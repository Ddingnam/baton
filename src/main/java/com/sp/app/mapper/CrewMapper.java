...
public interface CrewMapper {
	...
	public void updateCrew(CrewDto dto) throws Exception;
	public void deleteCrew(long crewIdx) throws Exception;
	
	public void insertCrewRegions(CrewDto dto) throws Exception;
	public void deleteCrewRegions(long crewIdx) throws Exception;
	
	public void insertCrewCategories(CrewDto dto) throws Exception;
