...
<link rel="stylesheet" href="${pageContext.request.contextPath}/dist/css/alba-article.css">
</head>
<body>
...
<script src="${pageContext.request.contextPath}/dist/js/alba-article.js"></script>
</body>
</html>