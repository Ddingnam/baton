        ...
        <form name="communityForm" method="post" enctype="multipart/form-data">
            ...
            <div class="editor-body">
                ...
                <div class="poll-wrapper">
                    ...
                    <div id="pollForm" class="poll-card" style="display:${not empty dto.pollTitle ? 'block' : 'none'};"> 
                        ...
                        <div class="poll-settings-bar">
                            <div class="setting-group">
                                <div class="date-picker-box">
                                    ...
                                    <input type="date" name="pollEndDate" id="pollEndDate" class="input-date-hidden" value="${dto.pollEndDate}">
                            ...
                            <div class="setting-toggles">
                                ...
                                <label class="mini-check" title="익명 투표">
                                    <input type="checkbox" name="pollAnonymous" id="pollAnonymous" ${dto.pollAnonymous ? 'checked' : ''}>
