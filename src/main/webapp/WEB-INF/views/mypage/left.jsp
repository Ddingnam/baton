...
<aside class="mp-sidebar">
	...
	<nav class="sb-nav">
		...
		<div class="sb-group">
		    ...
		    <a href="${pageContext.request.contextPath}/review/list?type=RECEIVED" class="sb-link"><i class="ri-star-line"></i> 받은 거래 후기</a> 
		    <a href="${pageContext.request.contextPath}/review/list?type=SENT" class="sb-link"><i class="ri-star-line"></i> 보낸 거래 후기</a> 
