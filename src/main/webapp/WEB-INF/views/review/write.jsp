...
<head>
    ...
    .tag-label input:checked + i { color: #6f42c1; }
    ...
    .content-textarea { 
        width: 100%; height: 160px; padding: 20px; border: 1px solid #E6E6E6; 
    ...
    .content-textarea:focus { border-color: #6f42c1; }
    .content-textarea::placeholder { color: #ADB5BD; font-weight: 500; }
    .btn-submit { 
        width: 100%; padding: 18px; background-color: #6f42c1; 
