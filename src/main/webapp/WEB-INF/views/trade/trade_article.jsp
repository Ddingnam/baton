                    ...
                    <div class="ta-action-panel">
                        ...
                        <div v-if="articleIsOwner" class="ta-owner-section">
                            ...
                            <div class="ta-owner-grid">
                                ...
                                <button v-else type="button" class="btn-manage edit-style" @click="$router.push('/write/' + article.productIdx)"><i class="ri-edit-line"></i> 수정</button>
